	    ...
	    return(
	      React.createElement("div", null, 
	        ...
	        React.createElement("div", {className: "col-md-4"}, 
	          ...
	          this.state.showPage === "myPolls" ? React.createElement(MyPolls, {onShowResults: this.handlePollResults}) : 
	          this.state.showPage === "pollResults" ? React.createElement(VoteResults, {poll: this.state.poll}) : 
	    ...
	    createPoll:function(poll, index){
	      return(
	         ...
	         React.createElement("a", {href: pollAppUrl + "/vote?id="+poll._id, target: "_blank"}, 
	          ...
	          React.createElement("button", {type: "button", onClick: this.handleResultButtonClick.bind(this,poll), className: "btn btn-success"}, 
	     "results" 
	          ), 
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = React.createClass({displayName: "module.exports",
	  ...
	  render:function(){
	    ...
	    return(
	      React.createElement("div", null, 
	      React.createElement("h1", null, "Congratulations!"), "  ", React.createElement("h3", null, "Your poll has been posted to"), 
